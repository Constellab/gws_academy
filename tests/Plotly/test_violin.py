...
class TestPlotlyViolinplot(BaseTestCase):
    def test_plotly_violinplot(self):
        ...
        expected_output = px.violin(data_frame=df, x='x', y='y', color='z',
