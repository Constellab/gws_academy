...
from gws_academy.Plotly.PlotlyBarplot.plotly_barplot import PlotlyBarplot
import plotly.express as px


class TestBarplot(BaseTestCase):
    def test_bar(self):
        ...
        expected_output = px.bar(data_frame=df, x='x', y='y', color='z',
