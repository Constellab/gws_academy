...
from gws_core import JSONDict, TaskRunner
...
"""
class TestIdToBiomass(TestCase):

    def test_id_to_biomass_2HBO(self):
        modele =  JSONDict(json.loads(SHORT_RECON3DMODEL_1))
        ...
        expected_json = JSONDict(json.loads(SHORT_RECON3DMODEL_1_2HBO))
